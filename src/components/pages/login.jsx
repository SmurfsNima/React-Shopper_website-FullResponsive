...
const Login = () => {
    ...
    const [msg , setMsg] = useState(' Alearddy have an account?')
  return (
    <div className="w-full h-[100vh] bg-pink-200 pt-[5%]">
      <div className="w-[600px] h-[550px] bg-white py-[5%] px-[7%] m-auto" >
        ...
        <div className="flex flex-col gap-8 mt-4  ">
          ...
          <input className={`border-[1px] h-[45px] pl-3 ${login==='Login'? 'hidden' : '' }`} type="password" placeholder="Your Password" />
        </div>
        ...
        <p className="mt-4 font-medium text-[18px]">
          {msg} <span onClick={()=> setLogin('Login')} className="text-red-500 font-bold cursor-pointer ">Login here</span>
        </p>
